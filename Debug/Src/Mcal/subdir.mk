...
Src/Mcal/Mcu.o: ../Src/Mcal/Mcu.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DSTM32F411VETx -DSTM32 -DSTM32F4 -DSTM32F411E_DISCO -DDEBUG -c -I../Inc -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Src/Mcal/Mcu.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
